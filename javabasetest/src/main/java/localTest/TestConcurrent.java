...
//        List<localTest.ReportEvent> lists = new LinkedList<>();
//        lists.add(new localTest.ReportEvent("port", 1,2020));
//        lists.add(new localTest.ReportEvent("port", 1,2022));
//        lists.add(new localTest.ReportEvent("port", 1,2024));
//        Collections.reverse(lists);
//        Set<localTest.ReportEvent> reportEvents = new HashSet<>();
//        reportEvents.addAll(lists);
//        Iterator<localTest.ReportEvent> iterator = reportEvents.iterator();
//        localTest.ReportEvent reportEvent ;
