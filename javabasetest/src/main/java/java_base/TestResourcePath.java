...
/**
 * @author chenpc
 * @version $Id: java_base.TestResourcePath.java, v 0.1 2018-05-21 11:37:14 chenpc Exp $
 */
public class TestResourcePath {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(testResourcePath.getClass().getClassLoader().getResource("java_base.Task.class").getPath());
    }
}
