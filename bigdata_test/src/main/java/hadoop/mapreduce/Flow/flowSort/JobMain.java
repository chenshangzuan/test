...
//        String input = "/Users/kled/git/test/bigdata_test/src/main/resources/flowsort";
//        String output = "/Users/kled/git/test/bigdata_test/src/main/resources/FlowSortOutput";
//        int exitCode = ToolRunner.run(new JobMain(), new String[]{input, output});
    ...
    public int run(String[] args) throws Exception {
        Job job = Job.getInstance(getConf(), "flowSort");
